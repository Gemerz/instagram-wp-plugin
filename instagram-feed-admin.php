...
function sb_instagram_settings_page() {
    ...
    $sb_instagram_lightbox = $options[ 'sb_instagram_lightbox' ];
    ...
    if( isset($_POST[ $sb_instagram_settings_hidden_field ]) && $_POST[ $sb_instagram_settings_hidden_field ] == 'Y' ) {
        ...
        if( isset($_POST[ $sb_instagram_customize_hidden_field ]) && $_POST[ $sb_instagram_customize_hidden_field ] == 'Y' ) {
            ...
            $sb_instagram_lightbox = $_POST[ 'sb_instagram_lightbox' ];
            ...
            $options[ 'sb_instagram_lightbox' ] = $sb_instagram_lightbox;
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input name="sb_instagram_lightbox" id="sb_instagram_lightbox" type="checkbox" <?php if($sb_instagram_lightbox == true) echo 'checked="checked"' ?> />
                        <span class="sbi_note"></span>
                    </td>
                </tr>
                <tr valign="top">
